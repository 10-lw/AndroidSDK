...
public class ArmDialog extends ArmBaseDialog implements IDialog {

    private ArmDialogController controller;
    ...
    public ArmDialog() {
        controller = new ArmDialogController(this);
    }
    ...
    public static class Builder {
        private ArmDialogController.ArmParams params;
        private IDialog.OnBuildListener buildListener;
        private IDialog.OnDismissListener dismissListener;
        ...
        public Builder(Context context) {
            ...
            params = new ArmDialogController.ArmParams();
         ...
         * @return Builder
         */
        public Builder setPositiveButton(int btnStr, IDialog.OnClickListener onclickListener) {
            params.positiveBtnListener = onclickListener;
            params.positiveStr = getStringById(btnStr);
            params.showBtnRight = true;
            return this;
        }
         ...
         * @return Builder
         */
        public Builder setNegativeButton(int btnStr, IDialog.OnClickListener onclickListener) {
            params.negativeBtnListener = onclickListener;
            params.negativeStr = getStringById(btnStr);
            params.showBtnLeft = true;
            return this;
        }

        public Builder setButtonTextSize(float textSize) {
            params.buttonTextSize = textSize;
            return this;
        }
        ...
        public Builder setTitle(int titleId) {
            params.titleStr = getStringById(titleId);
            return this;
        }
         ...
         * @return Builder
         */
        public Builder setContent(int stringId) {
            params.contentStr = getStringById(stringId);
            return this;
        }
        ...
        public Builder setContentTextSize(float textSize) {
            params.contentSize =  textSize;
            return this;
        }

        private ArmDialog create() {
            ArmDialog dialog = new ArmDialog();
         ...
         * @return ArmDialog
         */
        public ArmDialog show() {
            if (params.layoutRes <= 0 && params.dialogView == null) {
                //如果没有设置布局 提供默认设置
                setDefaultOption();
            }
            ArmDialog dialog = create();
        ...
        private void setDefaultOption() {
            ...
            params.layoutRes = R.layout.dialog_default_layout;
        ...
        private String getStringById(int stringId) {
            return params.context.getString(stringId);
        }
