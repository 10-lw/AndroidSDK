...
import com.william.androidsdk.widget.armdialog.manager.ArmDialogsManager;


public abstract class ArmBaseDialog extends DialogFragment {
    ...
    public void onDestroy() {
        super.onDestroy();
        ArmDialogsManager.getInstance().over();
    }
}
