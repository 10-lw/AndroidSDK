 ...
 * RecyclerView适配器基类
 */
public abstract class BaseDataBindingRecyclerViewAdapter<T>
                        extends RecyclerView.Adapter<BaseDataBindingRecyclerViewAdapter.ViewHolder> {
    private int variId;
...
//        notifyItemChanged(position);
    ...
    public BaseDataBindingRecyclerViewAdapter(List<T> mDataSet, int itemLayoutId, int variId) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ViewDataBinding dataBinding = DataBindingUtil.inflate(LayoutInflater.from(viewGroup.getContext()), itemLayoutId, viewGroup, false);
        return new ViewHolder(dataBinding);
    }

//    @Override
//    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int i) {
//        viewHolder.binding.setVariable(variId, mDataSet.get(i));
